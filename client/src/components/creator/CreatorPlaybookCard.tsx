  ...
  return (
    <Link href="/dashboard/playbook">
      ...
      >
        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-gray-500 capitalize">{data.niche} creator</p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between mb-3">
          <span className="text-[11px] text-gray-500">{data.completedCount}/{data.totalTasks} tasks</span>
        ...
        {stats && (
          <div className="flex gap-2 mb-3">
            <div className="flex items-center gap-1">
              ...
              <span className={`text-[11px] font-bold ${stats.lives.done ? 'text-green-400' : 'text-gray-400'}`}>
            ...
            <div className="flex items-center gap-1">
              ...
              <span className={`text-[11px] font-bold ${stats.reels.done ? 'text-green-400' : 'text-gray-400'}`}>
            ...
            <div className="flex items-center gap-1 ml-auto">
              ...
              <span className="text-[11px] font-bold text-amber-400">${stats.earnings.usd}</span>
            </div>
          </div>
        )}
        ...
        {data.todayTasks.length === 0 && (
          <p className="text-[11px] text-gray-600">No tasks scheduled today — rest up!</p>
        )}
      </motion.div>
    </Link>
  );
